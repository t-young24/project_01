/* ============================================================
   ...
   · 실제 서비스에서는 고객 문진 태블릿 → AI 구조화 → 이 형태의 JSON 으로 전달됨
...
/* 데이터 분석 근거 (C 화면 하단 안내) */
const INSIGHTS = [
  { icon: '⏱', text: '니즈 파악이 오래 걸린 상위 25% 구간은 응대 건수 -22.4%, 체험 안내 -33.8%. 응대카드로 "처음부터 다시 묻기"를 줄이는 것이 핵심이에요.' },
  { icon: '🚶', text: '워크인 고객은 예약 고객보다 니즈 파악에 2.1배(18.0분 vs 8.6분) 더 걸리고, 전체의 77.6%가 워크인이에요. 워크인도 대기열에서 응대카드가 반드시 생성돼요.' },
];
